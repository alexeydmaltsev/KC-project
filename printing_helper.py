class Printer:
    def __init__(self):
        pass
    def print_normal_stats(self, number_of_images, total_decode, total_encode,
                           total_size, total_reduction, total_MSE, total_SSIM, name):
        ...
        print(f'average file size reduction was \
        {round(total_reduction * 100 / number_of_images, 3)}%')
        print("\n")
